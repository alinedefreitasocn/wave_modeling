...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 20 15:58:06 2021
...
##############################################################################
# Functions for tracks plot with coordinates in Lambert projection
...
proj = ccrs.LambertConformal(central_longitude=-35,
    ...
    # central_longitude=13.3333, central_latitude=47.5,
...
ax.set_extent([-100, 30, 20, 805], crs=ccrs.PlateCarree())
